  ...
  return <>
    <section style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden" }}>
      ...
      <div className="sec-hero" style={{ maxWidth: 1200, margin: "0 auto", padding: "120px 40px 80px", textAlign: "center", position: "relative", zIndex: 2 }}>
        ...
        <Reveal delay={0.2}><p style={{ fontSize: 19, color: C.muted, maxWidth: 640, margin: "0 auto 44px", lineHeight: 1.7 }}>Gold PM&R delivers integrated co-management of inpatient rehab patients — Physical Medicine & Rehabilitation working alongside Internal Medicine, whether ours or yours — supported by proprietary technology that produces measurably superior outcomes for facilities and their patients.</p></Reveal>
...
function FacilitiesPage({ nav }) {
  const benefits = [
    ...
    { icon: "📊", title: "Superior Outcomes", desc: "Integrated co-management — Gold PM&R working alongside your IM team or ours — directly addresses the metrics that matter. Lower return-to-acute, ≥85% discharge-to-community, reduced 30-day readmissions. The integrated model produces results that uncoordinated single-specialty arrangements struggle to match." },
...
function PhysiciansPage({ nav }) {
  ...
  const cards = [
    { icon: "🤖", title: "AI-Powered Practice", desc: "Documentation co-pilot built for inpatient rehab eliminates 30–50% of documentation time. Automated billing. Compliance watchdog. Focus on patients." },
