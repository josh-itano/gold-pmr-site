  ...
  return <>
    <section style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden" }}>
      ...
      <div className="sec-hero" style={{ maxWidth: 1200, margin: "0 auto", padding: "120px 40px 80px", textAlign: "center", position: "relative", zIndex: 2 }}>
        ...
        <Reveal delay={0.2}><p style={{ fontSize: 19, color: C.muted, maxWidth: 640, margin: "0 auto 44px", lineHeight: 1.7 }}>Gold PM&R delivers integrated Physical Medicine & Rehabilitation and Internal Medicine co-management for inpatient rehab patients — clinical excellence across both specialties, supported by proprietary technology, producing measurably superior outcomes for facilities and their patients.</p></Reveal>
...
function FacilitiesPage({ nav }) {
  const benefits = [
    ...
    { icon: "📊", title: "Superior Outcomes", desc: "PM&R + Internal Medicine co-management directly addresses the metrics that matter — lower return-to-acute, ≥85% discharge-to-community, reduced 30-day readmissions. The integrated model produces results that single-specialty arrangements struggle to match." },
